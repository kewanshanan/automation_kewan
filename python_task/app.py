...
def add_book():
    ...
    return render_template('new_add_book.html')
...
def edit_book(book_index):
    ...
    return render_template('new_edit_book.html', book=book, index=book_index)
...
def search_books():
    if request.method == 'POST':
        ...
        return render_template('new_search.html', books=filtered_books, query=query)
